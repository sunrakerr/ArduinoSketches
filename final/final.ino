...
void setup() {
  ...
  while (!Serial);  
  delay(100);
  Serial.println("Enrollment Procedure");
  ...
  if (finger.verifyPassword()) {
    ...
    Serial.println("Fingerprint sensor disfunctional :( ");
    while (1) { delay(1); }
  }
...
void loop() {
  ...
  switch (ch){
    case '1':Serial.println("\nEnrollment time");
           ...
           Serial.println("Enter a roll number(1 to 127):");
           id = readnumber();
